...
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} forgot {STR_VAR_3}.\pAnd…\p{STR_VAR_1} learned {STR_VAR_2}!\p");
...
const u8 gText_FlaskHealedParty[] = _("You healed your Pokémon!\n{STR_VAR_1} flask uses left.{PAUSE_UNTIL_PRESS}");
const u8 gText_FlaskEmpty[] = _("The Potion Flask is empty!\nVisit a Pokémon Center to refill it.{PAUSE_UNTIL_PRESS}");
