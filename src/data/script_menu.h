...
static const struct MenuAction MultichoiceList_NurseServices[] =
    {
        {COMPOUND_STRING("HEAL")},
        {COMPOUND_STRING("LEVEL UP")},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
    {
        ...
        [MULTI_NURSE_SERVICES] = MULTICHOICE(MultichoiceList_NurseServices),
};
